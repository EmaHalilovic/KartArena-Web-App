...
public static class DependencyInjection
{
        ...
        IHostEnvironment env)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "KartArena API", Version = "v1" });
            var xml = Path.Combine(AppContext.BaseDirectory, "KartArena.API.xml");
            if (File.Exists(xml))
